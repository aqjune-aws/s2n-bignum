...
let p256k1shortintredlemma = prove
 (`!n. --(&p_256k1) <= n /\ n <= &17179873097 * &p_256k1
  ...
  REWRITE_TAC[GSYM INT_OF_NUM_CLAUSES] THEN CONV_TAC INT_REDUCE_WEAK_CONV THEN
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  SUBST1_TAC THENL
   [ONCE_REWRITE_TAC[GSYM MOD_ADD_MOD] THEN
    ...
    REWRITE_TAC[p_256k1] THEN CONV_TAC NUM_REDUCE_WEAK_CONV;
    ALL_TAC] THEN
...
let LOCAL_ROUGHSQR_P256K1_TAC =
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASM_REWRITE_TAC[] THEN CONJ_TAC THENL
   [MAP_EVERY EXPAND_TAC ["h"; "l"] THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
    BOUNDER_TAC[];
    ALL_TAC] THEN
  RULE_ASSUM_TAC(REWRITE_RULE[COND_SWAP; GSYM WORD_BITVAL]) THEN
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  SUBST_ALL_TAC THENL
   [EXPAND_TAC "n" THEN
    ...
    REWRITE_TAC[GSYM(NUM_REDUCE_WEAK_CONV `2 EXP 63`); DIMINDEX_64] THEN
    REWRITE_TAC[VAL_WORD_AND_POW2; NUM_REDUCE_WEAK_CONV `64 - 1`] THEN
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  SUBGOAL_THEN `m12' = 2 EXP 40 * 2 EXP 256 + 12 * m` SUBST_ALL_TAC THENL
   [FIRST_ASSUM(fun th ->
    ...
    CONV_TAC WORD_REDUCE_WEAK_CONV THEN ANTS_TAC THENL [ALL_TAC; ARITH_TAC] THEN
    REWRITE_TAC[WORD_AND_EQ_0] THEN CONV_TAC WORD_REDUCE_WEAK_CONV THEN
  ...
  ASSUME_TAC THENL
   [SUBGOAL_THEN `&p_256k1:int = &2 pow 256 - &4294968273` SUBST1_TAC THENL
     [REWRITE_TAC[p_256k1] THEN CONV_TAC INT_REDUCE_WEAK_CONV; ALL_TAC] THEN
  ...
  MP_TAC(SPEC `ca:num` p256k1redlemma) THEN ANTS_TAC THENL
   [REWRITE_TAC[GSYM INT_OF_NUM_CLAUSES] THEN
    ...
    MAP_EVERY UNDISCH_TAC
     [`m < 4294968274 * 2 EXP 256`; `n < 4294968274 * 2 EXP 256`] THEN
    REWRITE_TAC[GSYM INT_OF_NUM_CLAUSES] THEN
    REWRITE_TAC[p_256k1] THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
    CONV_TAC INT_ARITH;
    CONV_TAC(TOP_DEPTH_CONV let_CONV) THEN STRIP_TAC] THEN
...
let weierstrass_of_jacobian_p256k1_double = prove
 (`!P1 P2 x1 y1 z1 x3 y3 z3.
  ...
  REWRITE_TAC[p_256k1] THEN CONV_TAC INT_REDUCE_WEAK_CONV);;
