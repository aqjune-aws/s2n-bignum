...
let numsteps = count_nsteps (concl P256_SCALARMUL_SUBROUTINE_CORRECT)
    P256_SCALARMUL_EXEC;;

let full_spec = mk_safety_spec
    ~numinstsopt:numsteps
    (assoc "p256_scalarmul" subroutine_signatures)
    P256_SCALARMUL_SUBROUTINE_CORRECT
    P256_SCALARMUL_EXEC;;

let P256_SCALARMUL_SUBROUTINE_SAFE = time prove
 (full_spec,
  PROVE_SAFETY_SPEC P256_SCALARMUL_EXEC);;
