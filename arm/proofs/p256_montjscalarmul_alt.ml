...
let numsteps = count_nsteps (concl P256_MONTJSCALARMUL_ALT_SUBROUTINE_CORRECT)
    P256_MONTJSCALARMUL_ALT_EXEC;;

let full_spec = mk_safety_spec
    ~numinstsopt:numsteps
    (assoc "p256_montjscalarmul_alt" subroutine_signatures)
    P256_MONTJSCALARMUL_ALT_SUBROUTINE_CORRECT
    P256_MONTJSCALARMUL_ALT_EXEC;;

let P256_MONTJSCALARMUL_ALT_SUBROUTINE_SAFE = time prove
 (full_spec,
  PROVE_SAFETY_SPEC P256_MONTJSCALARMUL_ALT_EXEC);;
