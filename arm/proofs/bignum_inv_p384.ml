...
let numsteps = count_nsteps (concl BIGNUM_INV_P384_SUBROUTINE_CORRECT)
    BIGNUM_INV_P384_EXEC;;

let full_spec = mk_safety_spec
    ~numinstsopt:numsteps
    (assoc "bignum_inv_p384" subroutine_signatures)
    BIGNUM_INV_P384_SUBROUTINE_CORRECT
    BIGNUM_INV_P384_EXEC;;

let BIGNUM_INV_P384_SUBROUTINE_SAFE = time prove
 (full_spec,
  PROVE_SAFETY_SPEC BIGNUM_INV_P384_EXEC);;
