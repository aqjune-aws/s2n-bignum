...
let EDWARDS25519_EXPROJECTIVE_BOUND = prove
 (`!x y X Y Z W.
  ...
  CONV_TAC NUM_REDUCE_WEAK_CONV THEN SIMP_TAC[]);;
...
let X25519BASE_TABLE_LEMMA = prove
 (`read (memory :> bytes(word (pc + 0x2dfc),48576)) s =
  ...
  CONV_TAC NUM_REDUCE_WEAK_CONV THEN REWRITE_TAC[WORD_ADD] THEN
  ...
  REWRITE_TAC[IN_INTEGER_MOD_RING_CARRIER] THEN CONV_TAC INT_REDUCE_WEAK_CONV);;
...
let lemma1 = prove
 (`!(x0:num) x1 (y0:num) y1.
  ...
  CONV_TAC WORD_REDUCE_WEAK_CONV);;
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
   ...
   [TRANS_TAC EQ_TRANS
    ...
    CONJ_TAC THENL
     [ALL_TAC;
      ...
      CONV_TAC NUM_REDUCE_WEAK_CONV THEN REAL_ARITH_TAC] THEN
    SUBGOAL_THEN
     `(carry_s54 <=>
  ...
  ASSUME_TAC THENL
   [MAP_EVERY EXPAND_TAC ["q1"; "q2"; "q3"] THEN
    ...
    REPEAT(CONJ_TAC THENL
     [CONV_TAC NUM_REDUCE_WEAK_CONV THEN BOUNDER_TAC[]; ALL_TAC]) THEN
  ...
  SUBGOAL_THEN `2 EXP 256 * h + l = m * n` (SUBST1_TAC o SYM) THENL
   [DISCARD_STATE_TAC "s112" THEN MAP_EVERY EXPAND_TAC ["h"; "l"] THEN
    ...
    CONV_TAC WORD_REDUCE_WEAK_CONV THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
  ...
  SUBST1_TAC THENL
   [ONCE_REWRITE_TAC[GSYM MOD_ADD_MOD] THEN
    ...
    REWRITE_TAC[p_25519] THEN CONV_TAC NUM_REDUCE_WEAK_CONV;
    ALL_TAC] THEN
  ...
  REWRITE_TAC[REAL_VAL_WORD_XOR; WORD_AND_POW2_BITVAL;
              REWRITE_RULE[DIMINDEX_64; NUM_REDUCE_WEAK_CONV `64 - 1`]
   ...
   [SUBGOAL_THEN
    ...
    SUBST1_TAC THENL
     [REWRITE_TAC[val_def; DIMINDEX_64; bignum_of_wordlist] THEN
      ...
      CONV_TAC NUM_REDUCE_WEAK_CONV THEN ASM_REWRITE_TAC[BITVAL_CLAUSES] THEN
      ONCE_REWRITE_TAC[BIT_GUARD] THEN REWRITE_TAC[DIMINDEX_64] THEN
      CONV_TAC NUM_REDUCE_WEAK_CONV THEN REWRITE_TAC[BITVAL_CLAUSES] THEN
      ARITH_TAC;
      ALL_TAC] THEN
  ...
  CONJ_TAC THENL
   [REWRITE_TAC[ARITH_RULE `r < 2 EXP 255 <=> r DIV 2 EXP 192 < 2 EXP 63`] THEN
    EXPAND_TAC "r" THEN
    CONV_TAC(ONCE_DEPTH_CONV BIGNUM_OF_WORDLIST_DIV_CONV) THEN
    REWRITE_TAC[SYM(NUM_REDUCE_WEAK_CONV `2 EXP 63 - 1`)] THEN
...
let CURVE25519_X25519BASE_BYTE_CORRECT = time prove
 (`!res scalar n pc stackpointer.
  ...
  ASM_REWRITE_TAC[rfcx25519] THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
   ...
   [ARITH_TAC;
    ...
    CONJ_TAC THENL
     [MAP_EVERY EXPAND_TAC ["nn'"; "n_input"] THEN MATCH_MP_TAC(ARITH_RULE
      ...
      REWRITE_TAC[GSYM IN_NUMSEG; IN_GSPEC] THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
    ...
    SUBST1_TAC THENL
     [REWRITE_TAC[DIV_MOD] THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
    ...
    CONV_TAC(LAND_CONV NUM_REDUCE_WEAK_CONV) THEN
    ...
    ASSUME_TAC THENL
     [EXPAND_TAC "nn'" THEN REWRITE_TAC[GSYM BIGNUM_FROM_MEMORY_BYTES] THEN
      ...
      REWRITE_TAC[VAL_WORD_USHR] THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
    ...
    STRIP_ASSUME_TAC THENL
     [UNDISCH_TAC `ix <= 8` THEN
      ...
      REWRITE_TAC[p_25519] THEN CONV_TAC INT_REDUCE_WEAK_CONV;
      ALL_TAC] THEN
     ...
     [CONV_TAC(ONCE_DEPTH_CONV BIGNUM_LEXPAND_CONV) THEN
      ...
      ASM_REWRITE_TAC[MULT_CLAUSES; INT_NEG_0; INT_MUL_RZERO; GROUP_NPOW] THENL
       [REWRITE_TAC[group_pow; EDWARDS25519_GROUP; edwards_0] THEN
        REWRITE_TAC[edwards25519_epprojective; INTEGER_MOD_RING_CLAUSES] THEN
        REWRITE_TAC[p_25519] THEN CONV_TAC INT_REDUCE_WEAK_CONV THEN SIMP_TAC[];
        ALL_TAC] THEN
      ...
      REWRITE_TAC[INT_LT_REM_EQ; p_25519] THEN CONV_TAC INT_REDUCE_WEAK_CONV THEN
      ...
      EXISTS_TAC `(&2:int) pow 256` THEN CONJ_TAC THENL
       [FIRST_X_ASSUM(MATCH_MP_TAC o MATCH_MP (INT_ARITH
        ...
        CONV_TAC INT_REDUCE_WEAK_CONV THEN BOUNDER_TAC[];
    ...
    ANTS_TAC THENL
     [REWRITE_TAC[EDWARDS_NONSINGULAR_25519] THEN
      ...
      CONV_TAC INT_REDUCE_WEAK_CONV THEN REWRITE_TAC[GSYM p_25519] THEN
    ...
    SUBGOAL_THEN `&e_25519 = (-- &1) rem &p_25519` SUBST_ALL_TAC THENL
     [REWRITE_TAC[e_25519; p_25519] THEN CONV_TAC INT_REDUCE_WEAK_CONV;
      ALL_TAC] THEN
    CONV_TAC INT_REM_DOWN_CONV THEN
 ...
 (*** Bytewise store and finish of simulation ***)
  ...
  REWRITE_TAC[p_25519] THEN CONV_TAC INT_REDUCE_WEAK_CONV THEN
  ...
  REWRITE_TAC[LE_0; p_25519] THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
  ...
  ASM_CASES_TAC `x = 0` THEN ASM_REWRITE_TAC[] THENL
   [UNDISCH_THEN `x = 0` SUBST1_TAC THEN
    ...
    REWRITE_TAC[p_25519] THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
    STRIP_TAC THEN ASM_REWRITE_TAC[] THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
  ...
  REWRITE_TAC[GSYM INT_REM_EQ; p_25519] THEN CONV_TAC INT_REDUCE_WEAK_CONV THEN
   ...
   [SIMP_TAC[PRIME_COPRIME_EQ; PRIME_P25519] THEN REWRITE_TAC[num_divides] THEN
    ...
    ASM_REWRITE_TAC[NOT_IMP] THEN CONJ_TAC THENL
     [FIRST_X_ASSUM(MATCH_MP_TAC o MATCH_MP (NUMBER_RULE
      ...
      CONV_TAC NUM_REDUCE_WEAK_CONV THEN ASM_REWRITE_TAC[]];
