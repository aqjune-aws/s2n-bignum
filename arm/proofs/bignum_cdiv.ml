    ...
    CONJ_TAC THENL
     [(*** Start by globalizing the nonzero assumption ***)
      ...
      STRIP_ASSUME_TAC THENL
       [CONV_TAC REAL_RAT_REDUCE_WEAK_CONV THEN MP_TAC(ISPEC `a:int64` MSB_VAL) THEN
        ...
        CONV_TAC NUM_REDUCE_WEAK_CONV THEN ASM_REWRITE_TAC[] THEN
        CONV_TAC WORD_REDUCE_WEAK_CONV THEN ARITH_TAC;
        ALL_TAC] THEN
      ...
      CONV_TAC(LAND_CONV NUM_REDUCE_WEAK_CONV) THEN ANTS_TAC THENL
