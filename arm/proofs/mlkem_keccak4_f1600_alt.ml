...
(*
let numsteps = count_nsteps (concl MLKEM_KECCAK4_F1600_ALT_SUBROUTINE_CORRECT)
    MLKEM_KECCAK4_F1600_ALT_EXEC;;

let full_spec = mk_safety_spec
    ~numinstsopt:numsteps
    (assoc "mlkem_keccak4_f1600_alt" subroutine_signatures)
    MLKEM_KECCAK4_F1600_ALT_SUBROUTINE_CORRECT
    MLKEM_KECCAK4_F1600_ALT_EXEC;;
*)

let MLKEM_KECCAK4_F1600_ALT_SUBROUTINE_SAFE = time prove
 ...
 forall a rc A1 A2 A3 A4 pc stackpointer returnaddress.
     ...
     ==> ensures2 arm
         ...
         (\s. 9502)
         (\s. 9502)`,
  PROVE_SAFETY_SPEC MLKEM_KECCAK4_F1600_ALT_EXEC);;
