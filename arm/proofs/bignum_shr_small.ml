...
let numsteps = count_nsteps (concl BIGNUM_SHR_SMALL_SUBROUTINE_CORRECT)
...
let BIGNUM_SHR_SMALL_SUBROUTINE_SAFE = time prove
 (full_spec,
  PROVE_SAFETY_SPEC BIGNUM_SHR_SMALL_EXEC);;
