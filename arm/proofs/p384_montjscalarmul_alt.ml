...
let numsteps = count_nsteps (concl P384_MONTJSCALARMUL_ALT_SUBROUTINE_CORRECT)
    P384_MONTJSCALARMUL_ALT_EXEC;;

let full_spec = mk_safety_spec
    ~numinstsopt:numsteps
    (assoc "p384_montjscalarmul_alt" subroutine_signatures)
    P384_MONTJSCALARMUL_ALT_SUBROUTINE_CORRECT
    P384_MONTJSCALARMUL_ALT_EXEC;;

let P384_MONTJSCALARMUL_ALT_SUBROUTINE_SAFE = time prove
 (full_spec,
  PROVE_SAFETY_SPEC P384_MONTJSCALARMUL_ALT_EXEC);;
