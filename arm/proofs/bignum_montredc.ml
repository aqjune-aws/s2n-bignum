...
let numsteps = count_nsteps (concl BIGNUM_MONTREDC_SUBROUTINE_CORRECT)
    BIGNUM_MONTREDC_EXEC;;

let full_spec = mk_safety_spec
    ~numinstsopt:numsteps
    (assoc "bignum_montredc" subroutine_signatures)
    BIGNUM_MONTREDC_SUBROUTINE_CORRECT
    BIGNUM_MONTREDC_EXEC;;

let BIGNUM_MONTREDC_SUBROUTINE_SAFE = time prove
 (full_spec,
  PROVE_SAFETY_SPEC BIGNUM_MONTREDC_EXEC);;
