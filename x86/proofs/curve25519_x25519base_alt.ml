 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASSUME_TAC THENL
   [REWRITE_TAC[ARITH_RULE `a + 1 <= b <=> a < b`] THEN
    SIMP_TAC[RDIV_LT_EQ; EXP_EQ_0; ARITH_EQ] THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
  ...
  ASSUME_TAC THENL
   [EXPAND_TAC "qm" THEN
    ...
    CONV_TAC WORD_REDUCE_WEAK_CONV THEN REWRITE_TAC[MULT_SYM] THEN
  ...
  SUBST1_TAC THENL
   [CONV_TAC SYM_CONV THEN MATCH_MP_TAC FLAG_FROM_CARRY_LT THEN
    ...
    REWRITE_TAC[REAL_BITVAL_NOT] THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
 ...
 (REWRITE_TAC[C_ARGUMENTS; C_RETURN; SOME_FLAGS; NONOVERLAPPING_CLAUSES] THEN
  ...
  ASSUME_TAC THENL
   [EXPAND_TAC "qm" THEN
    ...
    CONV_TAC WORD_REDUCE_WEAK_CONV THEN MATCH_MP_TAC MOD_LT THEN
  ...
  REWRITE_TAC[REAL_CONGRUENCE; p_25519] THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
  EXPAND_TAC "ca" THEN
  REWRITE_TAC[p_25519; bignum_of_wordlist; GSYM REAL_OF_NUM_CLAUSES] THEN
  ACCUMULATOR_ASSUM_LIST(MP_TAC o end_itlist CONJ o DESUM_RULE) THEN
 ...
 (`!res scalar n pc stackpointer.
  ...
  REPEAT CONJ_TAC THENL
   [ARITH_TAC;
    ...
    CONV_TAC(LAND_CONV WORD_REDUCE_WEAK_CONV) THEN
    ...
    CONJ_TAC THENL
     [MAP_EVERY EXPAND_TAC ["nn'"; "n_input"] THEN MATCH_MP_TAC(ARITH_RULE
      ...
      CONV_TAC(ONCE_DEPTH_CONV BIGNUM_OF_WORDLIST_DIV_CONV) THEN
      REWRITE_TAC[GSYM(NUM_REDUCE_WEAK_CONV `2 EXP 62 - 1`)] THEN
    ...
    SUBST1_TAC THENL
     [EXPAND_TAC "n_input" THEN ONCE_REWRITE_TAC[bignum_of_wordlist] THEN
      ...
      REWRITE_TAC[MOD_MULT_ADD] THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
 ...
 (`!res scalar n pc stackpointer returnaddress.
    ...
    ==> ensures x86
         ...
         (MAYCHANGE [RSP] ,, MAYCHANGE_REGS_AND_FLAGS_PERMITTED_BY_ABI ,,
          MAYCHANGE [memory :> bytes(res,32);
                     memory :> bytes(word_sub stackpointer (word 536),536)])`,
  REWRITE_TAC[GSYM(CONV_RULE NUM_REDUCE_WEAK_CONV
