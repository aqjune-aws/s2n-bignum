...
let X86_SIM_TAC execth snums =
  PUSH_TIMER_TAC THEN
  REWRITE_TAC(!simulation_precanon_thms) THEN
  PRINT_ELAPSED_TIME_TAC "X86_SIM_TAC-1" THEN
  PUSH_TIMER_TAC THEN
  ENSURES_INIT_TAC "s0" THEN
  PRINT_ELAPSED_TIME_TAC "X86_SIM_TAC-ENSURES_INIT_TAC" THEN
  PUSH_TIMER_TAC THEN
  X86_STEPS_TAC execth snums THEN
  PRINT_ELAPSED_TIME_TAC "X86_SIM_TAC-X86_STEPS_TAC" THEN
  PUSH_TIMER_TAC THEN
  ENSURES_FINAL_STATE_TAC THEN
  PRINT_ELAPSED_TIME_TAC "X86_SIM_TAC-ENSRES_FINAL_STATE_TAC" THEN
