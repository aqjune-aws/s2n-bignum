...
let PRIME_PSM2 = time prove
 (`prime p_sm2`,
  REWRITE_TAC[p_sm2] THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
...
let TWOS_COMPLEMENT_320_WEAK = prove
 (`(&(bignum_of_wordlist[n0;n1;n2;n3;n4]) == x) (mod (&2 pow 320))
  ...
  ASM_REWRITE_TAC[ARITH_EQ; NUM_REDUCE_WEAK_CONV `320 - 1`] THEN
 ...
 (`!z x n pc stackpointer.
  ...
  THEN REPEAT CONJ_TAC THENL
   [ARITH_TAC;
    ...
    DISCARD_STATE_TAC "s48" THEN CONV_TAC NUM_REDUCE_WEAK_CONV THEN
    ...
    ANTS_TAC THENL
     [EXPAND_TAC "t" THEN MATCH_MP_TAC DIVSTEP_F_ODD THEN
      REWRITE_TAC[p_sm2] THEN CONV_TAC INT_REDUCE_WEAK_CONV;
          ...
          STRIP_ASSUME_TAC THENL
           [EXPAND_TAC "t" THEN CONJ_TAC THENL
             [MATCH_MP_TAC DIVSTEP_F_BOUNDS;
              MATCH_MP_TAC DIVSTEP_G_BOUNDS] THEN
            REWRITE_TAC[p_sm2] THEN CONV_TAC INT_REDUCE_WEAK_CONV THEN
    ...
    THENL
     [REPEAT GEN_TAC THEN MATCH_MP_TAC(INTEGER_RULE
      ...
      REWRITE_TAC[COPRIME_2; p_sm2] THEN CONV_TAC NUM_REDUCE_WEAK_CONV;
      ALL_TAC] THEN
    SUBGOAL_THEN
  ...
  REPEAT CONJ_TAC THENL
   [REWRITE_TAC[INT_OF_NUM_CLAUSES; GSYM num_coprime] THEN
    REWRITE_TAC[COPRIME_LEXP; COPRIME_2; p_sm2] THEN CONV_TAC NUM_REDUCE_WEAK_CONV;
  ...
  RULE_ASSUM_TAC(REWRITE_RULE[NUM_REDUCE_WEAK_CONV `562 - 5 * 9`]) THEN
  ASM_REWRITE_TAC[]);;
