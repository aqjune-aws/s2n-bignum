 ...
 (`!k a x pc.
  ...
  ASM_REWRITE_TAC[] THEN REPEAT CONJ_TAC THENL
   [REWRITE_TAC[BIGNUM_FROM_MEMORY_BYTES] THEN
    ...
    REWRITE_TAC[BIGNUM_FROM_MEMORY_TRIVIAL] THEN CONV_TAC WORD_REDUCE_WEAK_CONV;
    ...
    FIRST_X_ASSUM(DISJ_CASES_THEN MP_TAC) THENL
     [DISCH_THEN(CONJUNCTS_THEN SUBST_ALL_TAC) THEN
      ...
      CONV_TAC WORD_REDUCE_WEAK_CONV THEN CONV_TAC WORD_RULE;
    ...
    EXPAND_TAC "d" THEN SIMP_TAC[VAL_WORD_EQ; DIMINDEX_64; BIGDIGIT_BOUND] THEN
     CONV_TAC NUM_REDUCE_WEAK_CONV THEN ONCE_REWRITE_TAC[WORD_SUB] THEN
